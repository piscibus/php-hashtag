...
test('extract with arabic text', function () {
    $actual = extract_hashtags('هذا هو #تجربة و #تجربة2 و #foo_bar و #FooBar و #foo و #كلمة_و_أخرى');
...
test('extract with french text', function () {
    $actual = extract_hashtags('Ceci est un #test et un autre #test2 et #foo_bar et #FooBar et #foo et #superposés');
...
test('extract with turkish text', function () {
    $actual = extract_hashtags('Bu bir #test ve başka bir #test2 ve #foo_bar ve #FooBar ve #foo ve #üstüste');
...
test('extract with spanish text', function () {
    $actual = extract_hashtags('Esto es un #test y otro #test2 y #foo_bar y #FooBar y #foo y #superpuestos');
